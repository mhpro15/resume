...
const angularLogo = (
  <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 600 600">
    <path d="M185.7 268.1h76.2l-38.1-91.6-38.1 91.6zM223.8 32L16 106.4l31.8 275.7 176 97.9 176-97.9 31.8-275.7zM354 373.8h-48.6l-26.2-65.4H168.6l-26.2 65.4H93.7L223.8 81.5z" /></svg>
);
const nodeLogo = (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 600">
...
const csharpLogo = (
  <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 -1.428 350 350.108" >
    ...
    <path d="m128.182 143.241-125.194 72.084c2.053 3.711 5.169 6.813 9.386 9.254 20.206 11.703 88.02 50.547 101.56 58.536 9.106 5.373 17.997 5.565 27.17.27 34.015-19.64 68.075-39.199 102.105-58.818 4.217-2.44 7.333-5.544 9.386-9.252z" fill="#280068" /><path d="m255.569 84.452c-.002-4.83-1.035-9.098-3.124-12.76l-124.263 71.55 124.413 72.073c1.994-3.608 2.985-7.793 2.987-12.518 0 0 0-78.889-.013-118.345" fill="#" /><g fill="#fffbac"><path d="m201.892 116.294v13.474h13.474v-13.474h6.737v13.474h13.474v6.737h-13.474v13.473h13.474v6.737h-13.474v13.474h-6.737v-13.474h-13.474v13.474h-6.737v-13.474h-13.473v-6.737h13.473v-13.473h-13.473v-6.737h13.473v-13.474zm13.474 20.21h-13.474v13.474h13.474z" />
...
export const skills = {
  soft: [
    { icon: listenLogo, text: "Active Listening" },
    { icon: communicateLogo, text: "Effective Communication" },
    { icon: collabLogo, text: "Collaboration" },
    { icon: soloLogo, text: "Independence" },
    { icon: teamLogo, text: "Teamwork" },
    { icon: ideaLogo, text: "Creative Problem Solving" },
    { icon: timeLogo, text: "Time management" },
  ],
  hard: [
    { icon: htmlLogo, text: "HTML" },
    { icon: cssLogo, text: "CSS" },
    { icon: jsLogo, text: "JavaScript" },
    { icon: reactLogo, text: "React" },
    { icon: angularLogo, text: "Angular" },
    { icon: nodeLogo, text: "Node" },
    { icon: pythonLogo, text: "Python" },
    { icon: csharpLogo, text: "C#" },
    { icon: javaLogo, text: "Java" },
    { icon: typescriptLogo, text: "TypeSript" },
    { icon: sqlLogo, text: "SQL" },
    { icon: nosqlLogo, text: "noSQL" },
    { icon: gitLogo, text: "Git" },
    { icon: algorithmsLogo, text: "Data Structures and Algorithms" },
  ],
};
